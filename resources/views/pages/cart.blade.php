...
.cart-qty-btn{width:36px;height:36px;border-radius:50%;border:1.5px solid var(--border);background:var(--bg-2);cursor:pointer;display:flex;align-items:center;justify-content:center;font-size:.85rem;font-weight:700;}
      ...
      <div class="order-summary">
        ...
        <form method="POST" action="{{ route('checkout') }}" id="checkoutForm" style="margin-top:20px;">
          ...
          <div class="form-group">
            ...
            <select name="delivery_district" class="form-input form-select" required>
