  ...
  <div class="container" style="padding:48px 20px 28px;">
    ...
    <div class="footer-grid" style="display:grid;grid-template-columns:1.4fr 1fr 1fr auto;gap:40px;align-items:start;margin-bottom:40px;">
      ...
      <div>
        ...
        <p style="font-size:.82rem;color:var(--gray-400);line-height:1.6;max-width:280px;margin-bottom:18px;">Built for the working Malawian farmer — weather, markets, courses and crop health in one place.</p>
        <div style="display:flex;gap:6px;">
          <a href="#top" title="Back to top" onclick="event.preventDefault();document.getElementById('top').scrollIntoView({behavior:'smooth'});" style="width:34px;height:34px;border-radius:8px;border:1px solid rgba(255,255,255,.08);display:flex;align-items:center;justify-content:center;color:var(--gray-400);text-decoration:none;font-size:.82rem;transition:all .2s;" onmouseover="this.style.borderColor='var(--primary)';this.style.color='var(--primary)';this.style.transform='translateY(-2px)'" onmouseout="this.style.borderColor='rgba(255,255,255,.08)';this.style.color='var(--gray-400)';this.style.transform='none'"><i class="fas fa-arrow-up"></i></a>
        </div>
      </div>
