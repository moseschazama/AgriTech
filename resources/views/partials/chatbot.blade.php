...
// ── Districts & regions ────────────────────────────────────────────
const AGRI_REGIONS = [
  { kw: ['lilongwe'], name: 'Lilongwe', emoji: '🏞️', text: "🏞️ <strong>Lilongwe (Central Region):</strong><br>• Red-black loams, rains Nov–Apr (~900mm)<br>• Top crops: maize, soya, groundnuts, vegetables<br>• Plant maize with first rains; top dress CAN at knee height<br>• Use ridges across the slope to reduce run-off<br><a href='/learn?category=crop-production' style='color:var(--primary)'>→ Crop courses</a>" },
  { kw: ['blantyre','blantyre city'], name: 'Blantyre', emoji: '🌇', text: "🌇 <strong>Blantyre (Southern Region):</strong><br>• Hot and humid, moderate rain<br>• Top crops: vegetables, tomatoes, maize, pigeon peas<br>• Cover nursery beds on hot days; watch whiteflies<br><a href='/learn?category=vegetables' style='color:var(--primary)'>→ Vegetable courses</a>" },
  { kw: ['mzimba','mzuzu'], name: 'Mzimba / Mzuzu', emoji: '⛰️', text: "⛰️ <strong>Mzimba / Mzuzu (Northern Region):</strong><br>• Good rainfall, cool highlands<br>• Top crops: maize, tobacco, groundnuts; Mzuzu adds coffee & macadamia<br>• Full ridges help on the steeper hillsides" },
  { kw: ['kasungu'], name: 'Kasungu', emoji: '🌽', text: "🌽 <strong>Kasungu:</strong><br>• Sandy loams — lime acidic soils (pH below 5.5)<br>• Top crops: maize, tobacco, groundnuts<br>• Watch for early-season armyworm on young maize<br><a href='/diseases' style='color:var(--primary)'>→ Disease guides</a>" },
  { kw: ['dedza'], name: 'Dedza', emoji: '🥔', text: "🥔 <strong>Dedza (cool highlands):</strong><br>• One of Malawi's best areas for Irish potatoes<br>• Also maize, beans and peas<br>• Late blight is the #1 risk — spray early and use certified seed<br><a href='/diseases' style='color:var(--primary)'>→ Late blight guide</a>" },
  { kw: ['salima'], name: 'Salima', emoji: '💧', text: "💧 <strong>Salima (Lakeshore):</strong><br>• Hot lowlands with lake influence<br>• Top crops: rice, maize, and tomato/onion under irrigation<br>• Water management is key — treadle pumps work well here<br><a href='/innovation' style='color:var(--primary)'>→ Irrigation innovations</a>" },
  { kw: ['zomba'], name: 'Zomba', emoji: '🌿', text: "🌿 <strong>Zomba:</strong><br>• Good rainfall at the plateau<br>• Top crops: tobacco, maize, vegetables<br>• Plan for two seasons using valley water where available" },
  { kw: ['ntcheu'], name: 'Ntcheu', emoji: '🥜', text: "🥜 <strong>Ntcheu:</strong><br>• Famous for groundnuts — confectionery grade fetches top prices<br>• Also maize and beans<br>• Dry and store groundnuts away from moisture to avoid aflatoxin<br><a href='/marketplace' style='color:var(--primary)'>→ Sell groundnuts</a>" },
  { kw: ['machinga'], name: 'Machinga', emoji: '🌾', text: "🌾 <strong>Machinga:</strong><br>• Lakeshore plains — rice country<br>• Also cassava and maize<br>• Time the rice nursery to the rains, flood at tillering" },
  { kw: ['nkhata bay','nkhata'], name: 'Nkhata Bay', emoji: '🌴', text: "🌴 <strong>Nkhata Bay:</strong><br>• Tropical lakeshore — cassava, rice, macadamia<br>• Use crab-resistant seedbeds and guard chickens in rice season" },
  { kw: ['karonga'], name: 'Karonga', emoji: '☀️', text: "☀️ <strong>Karonga:</strong><br>• Hot northern lakeshore — rice, cassava, and short-season maize<br>• High heat: plant early and mulch to save moisture" },
  { kw: ['thyolo'], name: 'Thyolo', emoji: '🍵', text: "🍵 <strong>Thyolo:</strong><br>• Estate belt — tea, macadamia, bananas<br>• Smallholders grow maize + vegetables between estates<br>• Frequent rain; keep drainage channels clear" },
  { kw: ['mulanje'], name: 'Mulanje', emoji: '⛰️', text: "⛰️ <strong>Mulanje:</strong><br>• Cool tea/coffee slopes below the mountain<br>• Vegetables, cassava and rice on the plains<br>• Watch cold-season frost on vegetables" }
];
...
const GENERIC = {
  ...
  weather: { r: "🌤️ <strong>Weather & Planting Window:</strong><br>• Blantyre: 26°C, partly cloudy<br>• Lilongwe: 24°C, light rain expected<br>• Mzuzu: 21°C, cloudy<br>• Best window: plant as soon as rains establish (mid Nov–Dec)<br><small>Advice from Malawi's seasonal forecast.</small>", delay: 800 },
  ...
  sell: { r: "🛒 <strong>Sell on AgriTech Pro:</strong><br>• List products for FREE — no commission<br>• Reach 12,000+ buyers across Malawi<br>• Accept Airtel Money / TNM Mpamba<br>• Delivery is arranged automatically<br><a href='/marketplace' style='color:var(--primary)'>→ Start selling</a>", delay: 900 },
  competition: { r: "🏆 <strong>Farmer Innovation Challenge:</strong><br>• Submit your farming innovation — it's free<br>• Community votes pick the top 3<br>• 1st, 2nd & 3rd win cash prizes (up to K 25,000)<br>• The winners list is published and downloadable<br><a href='/innovation' style='color:var(--primary)'>→ View the Innovation Hub</a>", delay: 900 },
  funding: { r: "🤝 <strong>Grants & Support:</strong><br>• Look for seasonal input subsidies and NGO farmer programmes announced through extension workers<br>• AgriTech Pro links you to buyers, courses and suppliers to improve margins<br>• Follow the SMS alerts for funding windows in your district<br><a href='/register' style='color:var(--primary)'>→ Create a free account</a>", delay: 1000 },
  account: { r: "👤 <strong>Your account:</strong><br>• Register free — takes under a minute<br>• Track orders, follow courses, save farm records<br>• Receive disease & market alerts in your district<br><a href='/register' style='color:var(--primary)'>→ Register</a> · <a href='/login' style='color:var(--primary)'>→ Sign in</a>", delay: 900 },
